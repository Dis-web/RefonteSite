...
echo styleTitreNiveau1("Ils ont besoin de vous !", COLOR_ASSOCIATION);
?>
...
<div class='row'>
    <div class='col-6 mt-3'>
        ...
        ?>
        <!-- <h2 class='text-center mt-3 perso_ColorVertMenu perso_policeTitre perso_textShadow'></h2> -->
    </div>
    <div class='col-6 mt-3'>
        <?php
        $txt = "<img src='../../sources/images/Autres/icones/action.png' alt='logo News' />Evénements & Actions";
        echo styleTitreNiveau2($txt, COLOR_PENSIONNAIRES);
