...
echo styleTitreNiveau1("Association Nos Amis - Nos Animaux (N.A.N.A) <br/> Clermont (Ariège 09)", COLOR_ASSOCIATION);
?>
<?= styleTitreNiveau1("Contact", COLOR_CONTACTS) ?>

<?= styleTitreNiveau3("Suivez-nous :", COLOR_CONTACTS); ?>
<p class="pl-5">
...
<?= styleTitreNiveau3("Contactez-nous :", COLOR_CONTACTS) ?>
<div class="pl-5">
    <p>
...
<?= styleTitreNiveau3("Formulaire de contact :", COLOR_CONTACTS) ?>
<?php
if (
